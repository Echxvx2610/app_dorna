...
class Aplicacion():
    def __init__(self):
        ...
        self.button_zero_set = Button(self.raiz,relief='raised',bd=5,bg='pink',fg='white',activebackground = 'white',activeforeground = 'blue',text = 'Zero',font = ('DS-Digital 12'),width = 6,height = 2) #definimos el boton reset
